		...
		items: [
			...
			},
			{
				...
				items: [
					{
						text: "Магній",
						tooltip: "Взаємодія магнію з йодом, див. також кнопку \"+\"",
						content: {
							urlVideo: "video/video7.mp4",
							popup: {
								formulas: [
			...
			},
			{
				...
				items: [
					{
						text: "Алюміній",
						tooltip: "Взаємодія алюмінію з кислотою та лугом, див. також кнопку \"+\"",
						content: {
			...
			},
			{
				...
				items: [
					{
						text: "Залізо",
						tooltip: "Взаємодія заліза з сіркою, див. також кнопку \"+\"",
						content: {
			...
			},
			{
				...
				items: [
					{
						text: "Мідь",
						tooltip: "Взаємодія міді з розчином меркурій (ІІ) хлориду, див. також кнопку \"+\"",
						content: {
